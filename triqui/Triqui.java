...
public class Triqui {
    ...
    public static void main(String[] args) 
    {
        ...
        while(Gano == false)
        {
                ...
                if(tablero[a-1][b-1] != MARCA_VACIA )
                {
                    System.out.println("Error, El Tablero Ya Esta Marcado");   
                }
                else
                {
                ...
                if (tablero[a-1][b-1] != MARCA_VACIA) 
                {
                   System.out.println("Esta casilla ya esta marcada, por favor elige otra.");  
                    System.out.println("Error, El Tablero Ya Esta Marcado");   
                    System.out.println("Introduce Valores No Marcados");
                    System.out.println("Solo Tienes Este intento");
                    System.out.println("Introduce La Fila Numero: ");
                    a = teclado.nextInt();
                    System.out.println("Introduce La Columna Numero: ");
                    b = teclado.nextInt();
    ...
    {
        tablero[0][0] = MARCA_VACIA;
        tablero[0][1] = MARCA_VACIA; 
        tablero[0][2] = MARCA_VACIA; 
        int a, b;
        for( a = 0; a < TABLERO; a++)
        {
            for(b = 0; b < TABLERO; b ++)
